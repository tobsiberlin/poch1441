...
- **Spielsteine:** Track A verwendet R1 - matte Keramik-/Clay-Steine mit großer tonaler Blindprägung des Kartenrücken-Signets und feiner Rändelung. R1-Farben sind gemeinsame Tisch-Farbwelten, nie Spielerfarben; Steine morphen nach Gewinnen nicht. Track B verwendet ausschließlich individuell gealterte, gleichwertige 1-Cent-Münzen. Keine gemischten Nennwerte und keine Eurobeträge im UI.
- **Ein Tisch, auch beim Lernen:** Es gibt kein separates Tutorialbrett. Die echte Poch Disc bleibt geometrisch identisch und führt über die Lernzustände `Orientieren`, `Verbinden`, `Beweisen`, `Loslassen`; temporäre Labels und Hairlines verschwinden danach vollständig.
- **Portrait und Landscape:** Beide Orientierungen sind vollwertig spielbar. Landscape ist eine adaptive Tischkomposition mit stabiler Gegnerachse links, Entscheidung mittig, Disc rechts und Hand unten - keine gedrehte Portrait-Ansicht.
...
- **Gegner gestaffelt einführen:** Die erste Lernpartie hat eine feste Besetzung. Erst nach der ersten verstandenen Poch-Entscheidung wird eine öffentliche Spieltendenz erklärt. Freie Tische werden standardmäßig automatisch besetzt; manuelle Gegnerwahl bleibt freiwillig.
