...
- [ ] Game-Feel-Pass: Deal/Meld-Juice (40 ms), „Der Poch"-Tischschlag, Ketten-Kaskade, Tells - unter Parameter-Lock (§4). Morph-2-Label-Crossfade = Hand-Gate (Geräte-Tuning). ERLEDIGT 8.7.: Pott-Material, Slider-Rille, Wand-Pfeiler (Räte 5->8); Trumpf-Beat §6a + Melde-Strom §6a-b komplett (Kaskade, Freeze, Puls, Münzflüge, rollende Zähler, Prä-Melde-Anzeige, Skip, reduceMotion). OFFEN: Poch-Tischschlag, Münz-Bogenbahn (Hand-Gate), Balatro-Kollaps-Stufe-2, Sound.
