...
struct PlaneLockEvidenceManifest: Codable, Sendable {
    ...
    let frozenContractReference: String
    let frozenModelSHA256: String
    let frozenControllerSHA256: String
...
enum PlaneLockEvidenceRecorder {
    ...
    static func capture(controller: PlaneLockController) async throws {
        ...
        for index in 0..<82 {
            ...
            let file = "402x874-material-lock-v3-\(String(format: "%03d", index)).png"
        ...
        try writeContactSheet(
            images: frames,
            to: output.appendingPathComponent("uncut-material-lock-v3-sequence-402x874.png"),
            columns: 8,
            cellWidth: 100
        )
        ...
        try writeContactSheet(
            images: contactCrops,
            to: output.appendingPathComponent("tight-first-edge-contact-v3-strip-402x874.png"),
            columns: contactCrops.count,
            cellWidth: 190
        )

        let videoURL = output.appendingPathComponent("wallclock-material-lock-v3-402x874.mp4")
        ...
        let manifest = PlaneLockEvidenceManifest(
            ...
            frozenContractReference: FrozenMotionContract.reference,
            frozenModelSHA256: FrozenMotionContract.modelSHA256,
            frozenControllerSHA256: FrozenMotionContract.controllerSHA256,
            frozenW2ContractSHA256: FrozenMotionContract.w2ContractSHA256,
            productMaterial: "Production W2 CardBack unchanged; low-frequency stock tooth, uneven matte ink, subtle camping patina, thin dark exposed stock edge",
    ...
    private static func outputDirectory() throws -> URL {
        ...
        return documents.appendingPathComponent("CardMaterialLockEvidenceV3", isDirectory: true)
    }
}
