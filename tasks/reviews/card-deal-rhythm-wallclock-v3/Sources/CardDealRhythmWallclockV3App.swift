...
@main
struct CardDealRhythmWallclockV3App: App {
    var body: some Scene {
        WindowGroup {
            HarnessLauncherView()
        }
...
private struct HarnessLauncherView: View {
    private static let log = Logger(
        subsystem: "com.tobc.reviews.card-deal-rhythm-wallclock-v3",
        category: "Evidence"
    )
    ...
    var body: some View {
        ...
        .task {
            ...
            do {
                ...
                Self.log.info("Card deal rhythm V3 evidence export complete")
            } catch {
