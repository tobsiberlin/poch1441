...
enum CertifiedTranscript {
    static let sourceContractSHA256 = "8f50b68ff3141ad45f7d9eb751913c9c40af99678c15570a52821413561f6f16"

    /// The only plan instantiated by this harness. The production contract is
    /// compiled directly from App/MotionPlaybackPlan.swift by project.yml.
    ...
    static func validatedPlan() throws -> MotionPlaybackPlan {
        guard plan.isValid else { throw CertifiedTranscriptError.invalidPlan }
        return plan
    }
}

enum CertifiedTranscriptError: LocalizedError {
    case invalidPlan

    var errorDescription: String? {
        switch self {
        case .invalidPlan: "Der zertifizierte MotionPlaybackPlan ist ungültig"
        }
    }
}
