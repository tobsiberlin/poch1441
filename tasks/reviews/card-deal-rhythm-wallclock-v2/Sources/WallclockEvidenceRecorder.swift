...
enum WallclockEvidenceRecorder {
    ...
    private static func makeSequenceRecord(
        ...
        return HarnessSequenceRecord(
            ...
            cancellationClearSeconds: plan.cancellationSeconds.map {
                $0 + RhythmHarnessPlan.cancelClearSeconds
            },
    ...
    private static func outputDirectory() throws -> URL {
        ...
        return documents.appendingPathComponent("CardDealRhythmEvidenceV2", isDirectory: true)
    }
}
