import XCTest
import UIKit
@testable import CardMotionPlaneLockV1

final class PlaneLockTests: XCTestCase {
    ...
    func testEvidenceUsesMonotonicWallclockWithFixedStepAndNoSyntheticProgress() throws {
        ...
        let recorder = try String(
            contentsOf: root.appendingPathComponent("Sources/PlaneLockEvidenceRecorder.swift"),
            encoding: .utf8
        )
        let controller = try String(
            contentsOf: root.appendingPathComponent("Sources/PlaneLockController.swift"),
            encoding: .utf8
        )
