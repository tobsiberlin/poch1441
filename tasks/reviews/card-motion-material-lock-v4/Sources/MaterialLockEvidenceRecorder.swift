...
enum PlaneLockEvidenceRecorder {
    ...
    static func captureStaticGate() throws {
        ...
        try write(image: sourceImage, named: "402x874-static-source-v4.png", to: output)
        try write(image: stableRestImage, named: "402x874-static-rest-v4.png", to: output)
        try writeContactSheet(
            images: [sourceImage, stableRestImage],
            to: output.appendingPathComponent("static-source-rest-pair-v4-402x874.png"),
            columns: 2,
        ...
        try write(image: sourceCrop, named: "static-source-card-crop-v4.png", to: output)
        try write(image: restCrop, named: "static-rest-card-crop-v4.png", to: output)
        try writeContactSheet(
            images: [sourceCrop, restCrop],
            to: output.appendingPathComponent("static-material-crops-v4.png"),
            columns: 2,
            cellWidth: 190
        )
        ...
        let manifest = StaticMaterialGateManifest(
            ...
            viewport: "402x874",
            sourceFrame: "402x874-static-source-v4.png",
            stableRestFrame: "402x874-static-rest-v4.png",
    ...
    static func capture(controller: PlaneLockController) async throws {
        ...
        for index in 0..<82 {
            ...
            let file = "402x874-material-lock-v4-\(String(format: "%03d", index)).png"
        ...
        try writeContactSheet(
            images: frames,
            to: output.appendingPathComponent("uncut-material-lock-v4-sequence-402x874.png"),
            columns: 8,
            cellWidth: 100
        )
        ...
        try writeContactSheet(
            images: contactCrops,
            to: output.appendingPathComponent("tight-first-edge-contact-v4-strip-402x874.png"),
            columns: contactCrops.count,
            cellWidth: 190
        )

        let videoURL = output.appendingPathComponent("wallclock-material-lock-v4-402x874.mp4")
    ...
    private static func outputDirectory() throws -> URL {
        ...
        return documents.appendingPathComponent("CardMaterialLockEvidenceV4", isDirectory: true)
    }
    ...
    private static func staticOutputDirectory() throws -> URL {
        ...
        return documents.appendingPathComponent("CardMaterialLockStaticEvidenceV4", isDirectory: true)
    }
}
