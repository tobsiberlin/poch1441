...
enum PlaneLockEvidenceRecorder {
    ...
    static func capture(controller: PlaneLockController) async throws {
        ...
        for index in 0..<82 {
            ...
            let file = "402x874-material-lock-\(String(format: "%03d", index)).png"
        ...
        try writeContactSheet(
            images: frames,
            to: output.appendingPathComponent("uncut-material-lock-sequence-402x874.png"),
            columns: 8,
            cellWidth: 100
        )
        ...
        let videoURL = output.appendingPathComponent("wallclock-material-lock-402x874.mp4")
        ...
        let manifest = PlaneLockEvidenceManifest(
            ...
            productMaterial: "Production W2 CardBack: warm ink-black print, deterministic W2BackPatina, public damage overlay and neutral ivory-grey card stock",
    ...
    private static func outputDirectory() throws -> URL {
        ...
        return documents.appendingPathComponent("CardMaterialLockEvidenceV2", isDirectory: true)
    }
}
